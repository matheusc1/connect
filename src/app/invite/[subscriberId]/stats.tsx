  ...
  return (
    <div className="grid gap-3 md:grid-cols-3">
      <div className="relative bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1 rounded-xl">
        ...
        <LucideMousePointerClick className="size-5 text-purple absolute top-3 left-3" />
      </div>
      ...
      <div className="relative bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1 rounded-xl">
        ...
        <LucideBadgeCheck className="size-5 text-purple absolute top-3 left-3" />
      </div>
      ...
      <div className="relative bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col items-center justify-center gap-1 rounded-xl">
        ...
        <LucideMedal className="size-5 text-purple absolute top-3 left-3" />
      </div>
    </div>
  )
}
